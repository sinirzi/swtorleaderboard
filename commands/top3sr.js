...
module.exports = {
    ...
    execute(msg, args) {
        console.log('top3sr command called:',args)
        let randomImages = [];
        ...
        switch (args[0]) {
            case 'all':
                fetch('http://www.swtor.com/lb/data?page=1&class=shadow-assassin&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
            ...
            case 'assassin':
                ...
                break;
            case 'sage':
                fetch('http://www.swtor.com/lb/data?page=1&class=sage-sorcerer&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
            ...
            case 'vg':
            case 'vanguard':
                fetch('http://www.swtor.com/lb/data?page=1&class=vanguard-powertech&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
            ...
            case 'mando':
            case 'commando':
                fetch('http://www.swtor.com/lb/data?page=1&class=comando-mercenary&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
            ...
            case 'slinger':
            case 'gunslinger':
                fetch('http://www.swtor.com/lb/data?page=1&class=gunslinger-sniper&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
            ...
            case 'sco':
            case 'scoundrel':
                fetch('http://www.swtor.com/lb/data?page=1&class=scoundrel-operative&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
            ...
            case 'sent':
            case 'sentinel':
                fetch('http://www.swtor.com/lb/data?page=1&class=sentinel-marauder&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
            ...
            case 'marauder':
                ...
                break;
            case 'guardian':
                fetch('http://www.swtor.com/lb/data?page=1&class=guardian-juggernaut&column=pvp_ranked_solo&season=' +  season[1] +'').then(response => response.json()).then(file => {
                    newArrayDataOfOjbect = Object.values(file.data);
                    topThree = fonks.calcTopThree(newArrayDataOfOjbect);
