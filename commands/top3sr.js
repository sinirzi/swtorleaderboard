    ...
    execute(msg, args) {
        ...
        switch (args[0]) {
            case 'all':
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=sage-sorcerer&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=vanguard-powertech&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=comando-mercenary&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=gunslinger-sniper&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=scoundrel-operative&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=sentinel-marauder&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
                ...
                }).then(response => fetch('http://www.swtor.com/lb/data?page=1&class=guardian-juggernaut&column=pvp_ranked_solo&season=13')).then(response => response.json()).then(file => {
