...
module.exports = {
    name: '.tr',
    description: 'Team Ranked Rating !',
    execute(msg, args) {
        var argsNamed;
        var i;
        var j;
        ...
        function embedDataset() {
            ...
            const exampleEmbed = new Discord.MessageEmbed()
                ...
                .addFields(
                    { name: 'Rank', value: ranked.group_rank, inline: true },
                    { name: 'Rating', value: ranked.group_rating, inline: true },
                    { name: 'Server', value: ranked.shard_name, inline: true },
                    { name: 'MVP', value: ranked.group_mvp, inline: true },
                    { name: 'Wins', value: ranked.group_wins, inline: true },
